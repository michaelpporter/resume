...
\begin{twenty} % Environment for a list with descriptions
	\twentyitem{2019-present}{Showtime}{Sr. DevOps Engineer}{Designd and maintained Jenkins in Kubernetes, using pods for builds. Terrform for AWS to maintain and create EC2, CloudFront etc. for infrastructure. On call rotation.}
