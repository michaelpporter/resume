...
\skillstext{{Jenkins/5},{Kubernetes/4.5},{Terraform/5},{Helm/4.3},{Ansible/4},{Consul/3},{Docker/4.5},{ArgoCD/2}}
...
\begin{twenty} % Environment for a list with descriptions
	\twentyitem{2023-present}{Paramount+}{Sr. DevOps Engineer}{Lateral move from Showtime.}
	\twentyitem{2019-2023}{Showtime}{Sr. DevOps Engineer}{Designd and maintained Jenkins in Kubernetes, using pods for builds. Terrform for AWS to maintain and create EC2, CloudFront etc. for infrastructure. On call rotation.}
