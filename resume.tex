...
\cvdate{27 February 1970} % Date of birth
\cvaddress{Kansas City, MO} % Short address/location, use \newline if more than 1 line is required
\cvnumberphone{847-571-7122} % Phone number
\cvsite{https://en.wikipedia.org} % Personal website
\cvmail{mp@michaelpporter.com} % Email address
...
\skills{{Jenkins/5},{Kubernetes/4.5},{Terraform/5},{Helm/4.3}}
